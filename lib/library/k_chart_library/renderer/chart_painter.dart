...
import 'package:stockolio/library/k_chart_library/utils/number_util.dart';
...
class ChartPainter extends BaseChartPainter {
  ...
  int fixedLength;
  List<int> maDayList;
  late int lastPointIndex;
  late KLineEntity lastCandle;
...
//    }
  ...
  void updateCurrentPoint(KLineEntity updatedEntity) {
    if (currentPoint == null) {
      currentPoint = ValueNotifier(datas!.last);
    } else {
      currentPoint!.value = datas!.last;
      currentPoint!.value.high = updatedEntity.high;
      currentPoint!.value.low = updatedEntity.low;
      currentPoint!.value.close = updatedEntity.close;
      // var lastKline = datas!.last;
      // var test = KLineEntity.clone(lastKline);
      // test.d = lastKline.d;

      // test.open = updatedEntity.open;
      // test.high = updatedEntity.high;
      // test.low = updatedEntity.low;
      // test.close = updatedEntity.close;

      // currentPoint.value = test;
      print('difference ${currentPoint!.value != datas!.last}');
      datas!.last = currentPoint!.value;
    }
  }
...
//For TrendLine
  ...
  @override
  void drawLastPoint(Canvas canvas, Size size) {
    // TODO: implement drawLastPoint
  }
}
